...
try:
    ...
    from pandas_ta._version import version as __version__
except ImportError:
...
def _build_category_dict():
    ...
    1. Finding all subdirectories in pandas_ta (except special ones like __pycache__)
    ...
    # Get the directory containing this file (pandas_ta/)
